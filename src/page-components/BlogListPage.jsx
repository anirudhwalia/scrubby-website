...
import { blogPosts, blogCategories, getFeaturedPosts, getAuthorBySlug } from '../data/blog'
            ...
            <div className="grid md:grid-cols-3 gap-6 reveal">
              {featuredPosts.map((post) => {
                ...
                return (
                  ...
                  >
                    <div className="h-48 bg-gradient-to-br from-navy-800 to-navy-950 flex items-center justify-center overflow-hidden">
                      {post.thumbnail ? (
                        ...
                        <h3 className="font-display text-lg font-bold text-white text-center leading-tight group-hover:text-brand-green transition-colors p-6">
                          {post.title}
                        </h3>
                      )}
                    </div>
