...
import {
  ...
  Target, ArrowDownRight, RefreshCw, Sparkles, Clock, BarChart3, FileCheck
} from 'lucide-react'
...
const comparisonRows = [
  { feature: 'Primary Focus', millionverifier: 'Bulk email list verification & cleaning', scrubby: 'Risky / catch-all email validation' },
  { feature: 'Accuracy Rate', millionverifier: '99%+ deliverability guarantee', scrubby: '98.7% deliverability on risky emails' },
  { feature: 'Processing Speed', millionverifier: 'Fast bulk processing (minutes)', scrubby: '48-72 hours (deep inbox-level checks)' },
  { feature: 'Pricing', millionverifier: 'Affordable bulk rates from $29', scrubby: 'Starting at $27/mo, 100 free credits' },
  { feature: 'Catch-All Handling', millionverifier: 'Flags as risky / unknown', scrubby: 'Validates each catch-all address individually' },
  { feature: 'Verification Method', millionverifier: 'SMTP checks + pattern detection', scrubby: 'Deep inbox-level validation probes' },
  { feature: 'Result Categories', millionverifier: 'Good / Risky / Bad / Unknown', scrubby: 'Valid / Invalid (definitive results)' },
  { feature: 'Best For', millionverifier: 'Fast, affordable bulk list cleaning', scrubby: 'Recovering leads from risky segments' },
]

const keyDifferences = [
  {
    icon: BarChart3,
    title: 'Risky Email Resolution',
    description: 'MillionVerifier identifies risky and unknown emails during bulk verification but cannot resolve them further. Scrubby takes those flagged addresses and performs deep inbox-level validation to deliver definitive valid or invalid results.',
  },
  {
    icon: Clock,
    title: 'Speed vs Precision',
    description: 'MillionVerifier processes lists in minutes with fast SMTP-level checks, ideal for rapid bulk cleaning. Scrubby takes 48-72 hours but reaches deeper into catch-all domains where quick checks cannot determine deliverability.',
  },
  {
    icon: FileCheck,
    title: 'Affordable + Accurate',
    description: 'MillionVerifier offers some of the most competitive bulk verification pricing available. Combined with Scrubby, you get affordable initial cleaning plus deep validation of the risky segment, maximizing ROI on every list.',
  },
]
...
const workflowSteps = [
  {
    step: '01',
    title: 'Verify with MillionVerifier',
    description: 'Upload your email list to MillionVerifier for fast, affordable bulk verification. Remove invalid and bad emails instantly.',
    icon: RefreshCw,
  },
  {
    step: '02',
    title: 'Export Risky / Unknown',
    description: 'Filter and export the risky, unknown, and catch-all emails that MillionVerifier flagged but could not definitively verify.',
    icon: ArrowDownRight,
  },
  {
    step: '03',
  ...
  {
    step: '04',
    title: 'Deploy Clean List',
    description: 'Merge MillionVerifier verified emails with Scrubby-validated leads. Launch campaigns with maximum deliverability and zero wasted contacts.',
    icon: Sparkles,
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className="reveal">
          ...
          <h1 className="font-display font-800 text-4xl sm:text-5xl lg:text-[3.75rem] leading-[1.08] tracking-tight mb-6 max-w-4xl mx-auto">
            <span className="text-white">MillionVerifier + Scrubby: </span>
          ...
          <p className="text-lg sm:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto mb-10 font-body">
            MillionVerifier delivers fast, affordable bulk verification. Scrubby picks up the risky
            and unknown emails it flags, turning unresolved contacts into verified leads.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-ink-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
            MillionVerifier and Scrubby handle different stages of email validation.
            Here is a side-by-side look at what each tool does best.
          </p>
        </div>
    ...
    <section className="relative py-24 bg-surface-secondary">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-ink-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
            Understanding the core differences helps you use both tools effectively
            to maximize your email deliverability and list value.
          </p>
        </div>
    ...
    <section className="relative py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-ink-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
            Combine MillionVerifier&apos;s affordable bulk cleaning with Scrubby&apos;s deep risky email validation
            for maximum list quality at the best price.
          </p>
        </div>
          ...
          <div className="rounded-2xl p-10 md:p-16 text-center relative overflow-hidden" style={{ background: '#18181B' }}>
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-300 text-lg max-w-xl mx-auto mb-10 font-body">
                Start with 100 free credits. Upload your MillionVerifier risky segment and see
                how many verified leads you can recover from those unknown emails.
              </p>
...
export default function AlternativeMillionVerifierPage() {
  useEffect(() => {
  ...
  return (
    <main>
      <SEO
        title="Scrubby vs MillionVerifier — Email Validation Comparison"
        description="Compare Scrubby and MillionVerifier for email validation. See how Scrubby complements MillionVerifier to validate catch-all and risky emails with 98.7% accuracy."
        path="/alternatives/millionverifier"
        schema={buildComparisonSchema("MillionVerifier")}
      />
      <HeroSection />
      <ComparisonSection />
