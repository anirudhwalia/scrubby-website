...
import { getPostBySlug, getAuthorBySlug, blogCategories, blogPosts } from '../data/blogPosts'
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr_280px] gap-12">
            ...
            <article className="reveal">
              ...
              {/* Author Card */}
              {author && (
                <div className="mt-8 p-6 rounded-2xl bg-surface-secondary border border-slate-200">
