...
import {
  ...
  Target, ArrowDownRight, RefreshCw, Sparkles, GitBranch, Users, Database
} from 'lucide-react'
...
const comparisonRows = [
  { feature: 'Primary Focus', pipedrive: 'Sales CRM & pipeline management', scrubby: 'Risky / catch-all email validation' },
  { feature: 'Core Strength', pipedrive: 'Deal tracking & activity-based selling', scrubby: '98.7% deliverability on risky emails' },
  { feature: 'Contact Management', pipedrive: 'CRM contact & deal database', scrubby: 'Validates email contacts in your CRM' },
  { feature: 'Email Verification', pipedrive: 'No built-in email verification', scrubby: 'Deep inbox-level catch-all validation' },
  { feature: 'Catch-All Handling', pipedrive: 'Cannot detect catch-all emails', scrubby: 'Validates each catch-all individually' },
  { feature: 'Outreach Tools', pipedrive: 'Built-in email & activity tracking', scrubby: 'Ensures outreach reaches real inboxes' },
  { feature: 'Pricing', pipedrive: 'Plans from $14/mo per user', scrubby: 'Starting at $27/mo, 100 free credits' },
  { feature: 'Best For', pipedrive: 'Managing sales pipeline & deals', scrubby: 'Validating CRM contact emails' },
]

const keyDifferences = [
  {
    icon: GitBranch,
    title: 'CRM vs Validation',
    description: 'Pipedrive is a sales CRM built for managing deals, tracking activities, and driving pipeline growth. Scrubby ensures the email addresses stored in your Pipedrive contacts are actually deliverable, so your outreach efforts are never wasted.',
  },
  {
    icon: Users,
    title: 'Contact Data Quality',
    description: 'Pipedrive stores your sales contacts but has no way to verify if email addresses are valid. Scrubby validates those emails, especially risky catch-all addresses, so your sales team only reaches out to real inboxes.',
  },
  {
    icon: Target,
    title: 'Pipeline Protection',
    description: 'Pipedrive tracks deals through your pipeline, but bad email data means lost touch points. Scrubby ensures every email touchpoint in your pipeline reaches the right person, improving conversion rates across every stage.',
  },
]
...
const workflowSteps = [
  {
    step: '01',
    title: 'Export Pipedrive Contacts',
    description: 'Export email contacts from your Pipedrive CRM, focusing on contacts with unverified or aging email addresses.',
    icon: Database,
  },
  {
    step: '02',
    title: 'Validate Risky Emails',
    description: 'Upload the contact emails to Scrubby for deep inbox-level validation. Identify catch-all and risky addresses in 48-72 hours.',
    icon: Shield,
  },
  {
    step: '03',
    title: 'Update CRM Data',
    description: 'Remove or flag invalid emails in Pipedrive. Update contact records with Scrubby-validated clean email addresses.',
    icon: RefreshCw,
  },
  {
    step: '04',
    title: 'Outreach with Confidence',
    description: 'Send emails from Pipedrive knowing every contact address is verified. Improve response rates and protect your sender reputation.',
    icon: Sparkles,
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className="reveal">
          ...
          <h1 className="font-display font-800 text-4xl sm:text-5xl lg:text-[3.75rem] leading-[1.08] tracking-tight mb-6 max-w-4xl mx-auto">
            <span className="text-white">Pipedrive + Scrubby: </span>
          ...
          <p className="text-lg sm:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto mb-10 font-body">
            Pipedrive manages your sales pipeline. Scrubby validates the email contacts
            in your CRM, ensuring every outreach effort reaches a real inbox.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-ink-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
            Pipedrive is a sales CRM while Scrubby is an email validation specialist.
    ...
    <section className="relative py-24 bg-surface-secondary">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-ink-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
            Pipedrive and Scrubby are different tools that work powerfully together.
            Understanding their strengths helps you close more deals.
          </p>
        </div>
    ...
    <section className="relative py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-ink-secondary text-lg max-w-2xl mx-auto leading-relaxed font-body">
            Validate your Pipedrive contacts with Scrubby. Ensure every email
            in your CRM reaches a real inbox and drives pipeline growth.
          </p>
        </div>
          ...
          <div className="rounded-2xl p-10 md:p-16 text-center relative overflow-hidden" style={{ background: '#18181B' }}>
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-300 text-lg max-w-xl mx-auto mb-10 font-body">
                Start with 100 free credits. Validate your Pipedrive contacts and ensure
                every sales email reaches a real inbox for better pipeline conversion.
              </p>
...
export default function AlternativePipedrivePage() {
  useEffect(() => {
  ...
  return (
    <main>
      <SEO
        title="Scrubby vs Pipedrive — Email Validation Comparison"
        description="Compare Scrubby and Pipedrive for email validation. See how Scrubby complements Pipedrive to validate catch-all and risky emails with 98.7% accuracy."
        path="/alternatives/pipedrive"
        schema={buildComparisonSchema("Pipedrive")}
      />
      <HeroSection />
      <ComparisonSection />
