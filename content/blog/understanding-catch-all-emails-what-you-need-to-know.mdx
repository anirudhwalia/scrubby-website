...
featured: true
thumbnail: "/blog-images/understanding-catch-all-emails-what-you-need-to-know-thumbnail.svg"
---
...
**Risk of Deliverability Issues**: With catch-all addresses, there’s no guarantee that your emails will reach their intended recipients, jeopardizing deliverability and engagement metrics. This is especially damaging when running [cold outreach campaigns with tools like Kali](https://getkali.io), where every sent email needs to count.
...
**Bulk Validation**: Whether you have a small list or a massive database, Scrubby offers bulk validation capabilities, allowing you to clean your entire email list quickly and efficiently. Teams running a full [outsourced go-to-market strategy through Vendisys](https://vendisys.com) rely on this kind of validation to keep their outbound pipeline healthy.
